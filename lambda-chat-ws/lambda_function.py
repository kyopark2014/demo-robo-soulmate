...
def ISTP(chat, query):
    system = ( #ISTP
        ...
        - 질문: "햄버거의 색깔은?", 정답은 버건디 입니다. 정답를 물어보면 "넌센스 퀴즈 잖아." 라고 대답합니다.
        - 질문: "미꾸라지보다 더 큰 미꾸라지는?", 정답은 미꾸엑스라지 입니다. 정답를 물어보면 "넌센스 퀴즈 잖아." 라고 대답합니다.
        - 질문: "이탈리아의 날씨는?", 정답은 습하게띠 입니다. 정답를 물어보면 "넌센스 퀴즈 잖아." 라고 대답합니다.
        </quiz>
        """
    )
