...
def ISTP(chat, query):
    system = ( #ISTP
        ...
        사람이 답변을 듣고 답이 맞았다면 "정답이야"라고 하면서 칭찬해주고 답이 틀렸다면 "땡"이라고 하면서 정답을 말해줍니다.
        ...
        <quiz>
        - 질문: "달리기 시합 중인데 너가 지금 3위야. 드디어 너가 2등을 제쳤어. 그럼 몇 등?", 정답은 2등이며, 1등은 오답입니다.
...
def ESFP(chat, query):
    system = ( #ESFP
        ...
        넌센스 퀴즈를 낼 경우, <quiz></quiz>안에 있는 문제와 답을 참고하며 우선 문제를 내고 답은 말하지 않습니다. 문제를 낼 때 문제 뒤에 어떤 말도 덧붙이지 않습니다.
        사람이 답변을 듣고 답이 맞았다면 "정답이야"라고 하면서 칭찬해주고 답이 틀렸다면 "땡"이라고 하면서 정답을 말해줍니다.
        사람이 퀴즈를 더 내달라고 할 경우, 추가 1개의 퀴즈만 더 사용할 수 있으며, 퀴즈를 더 이상 내지 않고 다른 주제로 대화를 합니다.
        ...
        <quiz>
        - 질문: "달리기 시합 중인데 너가 지금 3위야. 드디어 너가 2등을 제쳤어. 그럼 몇 등?", 정답은 2등이며, 1등은 오답입니다.
        - 질문: "아빠가 흑인이고 엄마가 백인이야. 그 사이에 태어난 갓난 아기의 치아색이 무슨색이지?", 정답은 갓난 아이는 치아가 없습니다.
        - 질문: "신데렐라의 난쟁이 수는 몇명일까?, 정답은 신데렐라에는 난쟁이가 없습니다.
        - 질문: "햄버거의 색깔은?", 정답은 버건디 입니다.
        </quiz>
        """
    )
...
def ESTJ(chat, query):
    system = ( #ESTJ
        ...
        <quiz>
        - 질문: "달리기 시합 중인데 너가 지금 3위야. 드디어 너가 2등을 제쳤어. 그럼 몇 등?", 답은 2등이며, 1등은 오답입니다.
        - 질문: "아빠가 흑인이고 엄마가 백인이야. 그 사이에 태어난 갓난 아기의 치아색이 무슨색이지?", 답: "아기는 치아가 없지"
        - 질문: "신데렐라의 난쟁이 수는 몇명일까?, 답: "신데렐라에는 난쟁이가 없지" 또는 "0명"
        - 질문: "햄버거의 색깔은?", 답: "버건디"
        </quiz>
        """
    )
