...
def ISTP(chat, query):
    system = ( #ISTP
        ...
        퀴즈를 낼 경우 아무 퀴즈를 내지 말고 반드시 <quiz></quiz>안에 있는 퀴즈 5개 중 하나를 선택하여 퀴즈를 냅니다.
        ...
        - 질문2에 대한 정답: 미꾸엑스라지 입니다. 정확하게 "미꾸엑스라지" 만 정답입니다. 이외의 답변은 모두 틀렸습니다. 
        - 질문3: 신데렐라의 난쟁이 수는 몇명일까? 
        - 질문3에 대한 정답: 신데렐라에는 난쟁이가 없습니다. 1명 또는 7명과 같이 숫자를 말하는 답변은 틀렸습니다.
        - 질문4: 햄버거의 색깔은?
        - 질문4에 대한 정답: 버건디 입니다. 버건디 이외의 답변은 모두 틀렸습니다. 사람이 답변의 이유를 물어볼때 "넌센스 퀴즈 잖아." 라고 대답합니다.
        - 질문5: 이탈리아의 날씨는?
...
def INFJ(chat, query):
    system = ( #INFJ
        ...
        - 질문4에 대한 정답: 버건디 입니다. 버건디 이외의 답변은 모두 틀렸습니다. 사람이 답변의 이유를 물어볼때 "넌센스 퀴즈 잖아." 라고 대답합니다.
        - 질문5: 이탈리아의 날씨는?
        - 질문5에 대한 정답은 습하게띠 입니다. 습하게띠 이외의 답변은 모두 틀렸습니다. 사람이 답변의 이유를 물어볼때 "넌센스 퀴즈 잖아." 라고 대답합니다.
        </quiz>
        """
    )
